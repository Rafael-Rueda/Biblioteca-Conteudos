...
import { ReactComponent as CloudsSVG } from './images/clouds.svg';
    ...
    useEffect(() => {
        ...
        function moveElement(el, position, lr) {
            ...
            if (position < 408 && position > -380) {
                ...
                el.style.transform = `translate(${window.innerWidth > 1300 ? (lr === 'left' ? -120 : 150) : (lr === 'left' ? -250 : 250)}px, ${currentY}px)`;
            } else {
                el.style.transition = 'transform 0.7s ease';
        ...
        function elementCalc(el, lr) {
            ...
            // let [currentX, currentY] = getCurrentTranslate(el);
            // if ((position < 408 && position > -380) || (el.style.transform !== `translate(24.2px, ${currentY}px)`)) { moveElement(el, position, lr);}
